...
- `NativeVideoPlayer.cornerRadius` and `cornerBackgroundColor` round the iOS view's own corners and paint the host's page colour behind them, so hosts can keep a rectangular Flutter clip around a platform view.
